...
namespace tcp_ip_bridge
{
    ...
    std::vector<char> SensorMsgsMsgLaserScan::serialize(const std::shared_ptr<sensor_msgs::msg::LaserScan> &msg, std::vector<char> &packet)
    {
        ...
        RCLCPP_DEBUG(rclcpp::get_logger("sensor_msgs_msg_laser_scan::serialize"), "angle_min: %f", msg->angle_min);
        ...
        RCLCPP_DEBUG(rclcpp::get_logger("sensor_msgs_msg_laser_scan::serialize"), "angle_max: %f", msg->angle_max);
        ...
        RCLCPP_DEBUG(rclcpp::get_logger("sensor_msgs_msg_laser_scan::serialize"), "angle_increment: %f", msg->angle_increment);
        ...
        RCLCPP_DEBUG(rclcpp::get_logger("sensor_msgs_msg_laser_scan::serialize"), "time_increment: %f", msg->time_increment);
        ...
        RCLCPP_DEBUG(rclcpp::get_logger("sensor_msgs_msg_laser_scan::serialize"), "scan_time: %f", msg->scan_time);
        ...
        RCLCPP_DEBUG(rclcpp::get_logger("sensor_msgs_msg_laser_scan::serialize"), "range_min: %f", msg->range_min);
        ...
        RCLCPP_DEBUG(rclcpp::get_logger("sensor_msgs_msg_laser_scan::serialize"), "range_max: %f", msg->range_max);
        ...
        RCLCPP_DEBUG(rclcpp::get_logger("sensor_msgs_msg_laser_scan::serialize"), "ranges_size: %u", ntohl(ranges_size));
        ...
        RCLCPP_DEBUG(rclcpp::get_logger("sensor_msgs_msg_laser_scan::serialize"), "intensities_size: %u", ntohl(intensities_size));
    ...
    sensor_msgs::msg::LaserScan SensorMsgsMsgLaserScan::deserialize(std::vector<char> &packet, sensor_msgs::msg::LaserScan &msg)
    {
        ...
        RCLCPP_DEBUG(rclcpp::get_logger("sensor_msgs_msg_laser_scan::deserialize"), "angle_min: %f", msg.angle_min);

        memcpy(&msg.angle_max, packet.data(), sizeof(msg.angle_max));
        packet.erase(packet.begin(), packet.begin() + sizeof(msg.angle_max));

        RCLCPP_DEBUG(rclcpp::get_logger("sensor_msgs_msg_laser_scan::deserialize"), "angle_max: %f", msg.angle_max);
        ...
        RCLCPP_DEBUG(rclcpp::get_logger("sensor_msgs_msg_laser_scan::deserialize"), "angle_increment: %f", msg.angle_increment);
        ...
        RCLCPP_DEBUG(rclcpp::get_logger("sensor_msgs_msg_laser_scan::deserialize"), "time_increment: %f", msg.time_increment);

        memcpy(&msg.scan_time, packet.data(), sizeof(msg.scan_time));
        packet.erase(packet.begin(), packet.begin() + sizeof(msg.scan_time));

        RCLCPP_DEBUG(rclcpp::get_logger("sensor_msgs_msg_laser_scan::deserialize"), "scan_time: %f", msg.scan_time);

        memcpy(&msg.range_min, packet.data(), sizeof(msg.range_min));
        packet.erase(packet.begin(), packet.begin() + sizeof(msg.range_min));

        RCLCPP_DEBUG(rclcpp::get_logger("sensor_msgs_msg_laser_scan::deserialize"), "range_min: %f", msg.range_min);

        memcpy(&msg.range_max, packet.data(), sizeof(msg.range_max));
        packet.erase(packet.begin(), packet.begin() + sizeof(msg.range_max));

        RCLCPP_DEBUG(rclcpp::get_logger("sensor_msgs_msg_laser_scan::deserialize"), "range_max: %f", msg.range_max);
        ...
        RCLCPP_DEBUG(rclcpp::get_logger("sensor_msgs_msg_laser_scan::deserialize"), "ranges_size: %u", ranges_size);
        ...
        RCLCPP_DEBUG(rclcpp::get_logger("sensor_msgs_msg_laser_scan::deserialize"), "intensities_size: %u", intensities_size);
